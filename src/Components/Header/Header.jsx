...
function Header() {
  ...
  const handleInput = (evt) => {
    ...
    if (evt.target.value) {
      lab.current.style.border = "6px solid rgba(18, 18, 18, 0.2)";
      lab.current.style.borderBottom = "0";
      rec.current.style.border = "6px solid rgba(18, 18, 18, 0.2)";
      setIsVisible(true);
    } else {
      lab.current.style.border = "1px solid #000";
      rec.current.style.border = "1px solid #000";
  ...
  return (
    <>
      <header className="header header__logo">
      <img className="header__inner__logo" src={Logo} alt="Logo" />
          <div className="header__inner">
            ...
            <ul className="header__inner__list">
              ...
              <li className="header__inner__list__item plus">
                <img
              ...
              <li className="header__inner__list__item"  >
                <Link to='/accaunt'><img src={user} alt="USER" /></Link>
